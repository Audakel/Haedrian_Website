    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal', djmoney.models.fields.MoneyField(default=Decimal('0.0'), max_digits=10, decimal_places=2, default_currency=b'USD')),
                ('image', models.ImageField(null=True, upload_to=b'images/%Y-%m', blank=True)),
